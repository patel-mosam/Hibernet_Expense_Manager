...
<html lang="en">
  ...
  <div class="collapse" id="accounts">
    <ul class="nav flex-column sub-menu">
      <li class="nav-item"> <a class="nav-link" href="createaccount">Create Accounts</a></li>
      <li class="nav-item"> <a class="nav-link" href="listaccount">List Accounts</a></li>
    </ul>
  </div>
</li>

<li class="nav-item">
  <a class="nav-link" data-bs-toggle="collapse" href="#vendors" aria-expanded="false" aria-controls="vendors">
    <i class="icon-layout menu-icon"></i>
  ...
  <div class="collapse" id="vendors">
    <ul class="nav flex-column sub-menu">
      <li class="nav-item"> <a class="nav-link" href="addvendor">Add Vendors</a></li>
      <li class="nav-item"> <a class="nav-link" href="listvendor">List Vendors</a></li>
    </ul>
  </div>
</li>
...
<li class="nav-item">
  ...
  <div class="collapse" id="categories">
    <ul class="nav flex-column sub-menu">
      <li class="nav-item"> <a class="nav-link" href="category">Add Category</a></li>
      <li class="nav-item"> <a class="nav-link" href="listcategory">List Categories</a></li>
    </ul>
  </div>
</li>
...
<li class="nav-item">
  <a class="nav-link" data-bs-toggle="collapse" href="#subcategories" aria-expanded="false" aria-controls="subcategories">
    <i class="icon-layout menu-icon"></i>
  ...
  <div class="collapse" id="subcategories">
    <ul class="nav flex-column sub-menu">
      <li class="nav-item"> <a class="nav-link" href="subcategory">Add SubCategory</a></li>
      <li class="nav-item"> <a class="nav-link" href="listsubcategory">List SubCategories</a></li>
    </ul>
  </div>
</li>
...
<li class="nav-item">
  ...
  <div class="collapse" id="expense">
    <ul class="nav flex-column sub-menu">
      ...
      <li class="nav-item"> <a class="nav-link" href="listexpense">List Expenses</a></li>
    </ul>
  </div>
</li>
...
<li class="nav-item">
  ...
  <div class="collapse" id="income">
    <ul class="nav flex-column sub-menu">
      ...
      <li class="nav-item"> <a class="nav-link" href="listincome">List Income</a></li>
    </ul>
  </div>
</li>
